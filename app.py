...
if find_btn or _quick_run:
    if not origin_input.strip() or not dest_input.strip():
        ...
        _FALLBACK_MSGS = {
            ...
            "shade_gain_not_visible": "המסלול המוצל שנמצא ארוך יותר, אבל בלי שיפור נראה-לעין בחשיפה לשמש — מוצג המסלול הישיר.",
            "same_as_little_shade": "המסלול ל'הרבה צל' לא הראה שיפור נראה-לעין בחשיפה לשמש לעומת 'מעט צל' — מוצג מסלול 'מעט צל' הקצר יותר במקומו.",
        }
